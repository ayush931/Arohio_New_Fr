...
export default function DashboardUploads() {
  ...
  return (
    <div className="container py-4" style={{ background: "#f5f7fb", minHeight: "100vh" }}>
      ...
      {/* Header */}
      <div className="mb-3">
        <h1 className="h5 h-title mb-1">Upload PDFs for Image Extraction</h1>
        <div className="subtle">
          Upload your PDF files here. In the next stage, Arohio will extract all images from your document(s) and provide an Excel file listing those images.
        </div>
      </div>
        ...
        <div className="col-12 col-lg-8">
          ...
          >
            <div className="text-center">
              ...
              <div className="subtle small mt-1">Max size {MAX_MB}MB per file. Format: PDF only.</div>
            </div>
            <input
              ref={inputRef}
              type="file"
        ...
        <div className="col-12 col-lg-4 text-start">
          <div className="card-soft p-3 p-md-4">
            ...
            <ul className="mt-3 subtle">
              ...
              <li>Ensure figures and images inside your PDF are high resolution.</li>
            ...
            <a href="#learn" className="text-decoration-none" style={{ color: THEME, fontWeight: 700 }}>
              Learn how Arohio extracts images & exports to Excel →
            </a>
          </div>
        </div>
      </div>
